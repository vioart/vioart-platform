      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        >
          ...
          <p className="text-gray-400 leading-relaxed mb-6 max-w-md md:max-w-lg mx-auto md:mx-0 text-sm md:text-base">
            Backend Developer yang fokus pada pengembangan REST API dan sistem web yang scalable. 
            Berpengalaman menggunakan Node.js, Python dan Laravel untuk membangun aplikasi end-to-end serta deployment dengan Docker dan cloud platform. 
            Terbiasa menulis clean code, mengoptimalkan performa, dan merancang sistem yang maintainable untuk kebutuhan production.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            <a
              href="/pdf/Vio Arvendha - CV.pdf"
              download
              target="_blank"
              rel="noopener noreferrer"
              className="relative w-full sm:w-auto text-center px-6 py-3 rounded-xl text-white overflow-hidden group"
            >
